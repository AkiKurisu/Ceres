...
`[GenerateFlow]` tells `Ceres.Flow.SourceGenerator` to generate container/runtime boilerplate for a `partial` class.
...
- `Runtime/SourceGenerators/Source~/Ceres.Flow.SourceGenerator/Generators/FlowGraphGenerator.cs`
