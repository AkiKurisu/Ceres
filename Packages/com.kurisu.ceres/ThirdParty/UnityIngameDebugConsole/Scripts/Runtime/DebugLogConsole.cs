...
namespace Ceres.RuntimeConsole
{
	...
	public static class DebugLogConsole
	{
		...
		private static void ResetStatics()
		{
			...
			// Initialize Console Variables from Ceres Config system
		...
		private static void InitializeConsoleVariables()
		{
			...
			{
				Debug.LogError($"[Ceres] Failed to initialize console variables: {ex.Message}");
			}
		}
		...
		private static void RegisterConsoleVariable(ConfigVariable variable)
		{
			...
			{
				Debug.LogError($"[Ceres] Failed to register console variable {variableName}: {ex.Message}");
			}
		}
