...
namespace Unity.Ceres.CodeGen
{
    internal sealed class RuntimeAccessModifiersILPP : ILPPInterface
    {
        ...
        {
            return compiledAssembly.Name == CodeGenHelpers.GraphAssemblyName;
        }
        ...
        public override ILPostProcessResult Process(ICompiledAssembly compiledAssembly)
        {
            ...
            {
                m_Diagnostics.AddError($"[{compiledAssembly.Name}] Cannot read graph assembly definition.");
                return null;
            }
            ...
            {
                m_Diagnostics.AddError($"[{compiledAssembly.Name}] Cannot get the graph main module.");
            }
