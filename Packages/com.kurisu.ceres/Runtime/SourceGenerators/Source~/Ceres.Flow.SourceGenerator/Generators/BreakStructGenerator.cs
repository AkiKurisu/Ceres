...
[Generator]
public class BreakStructGenerator : FlowSourceGenerator, ISourceGenerator
{
    ...
    public void Execute(GeneratorExecutionContext context)
    {
        ...
        foreach (var structDeclaration in receiver.Candidates)
        {
            ...
            var generateAttribute = structSymbol
                .GetAttributes()
                .FirstOrDefault(x =>
                    x.AttributeClass?.ToDisplayString() == "Ceres.Flow.Annotations.ExecutableEventAttribute");
