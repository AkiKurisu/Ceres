...
internal class CustomEventGeneratorTemplate
{
    private const string StartTemplate =
        ...
        namespace {NAMESPACE}
        {
            ...
            public class ExecutableEvent_{CLASSNAME}: Ceres.Flow.CustomExecutionEvent<{CLASSNAME}>
            {
    ...
    private const string ImplementationTemplate =
        """
                ...
                protected override void LocalExecute(Ceres.Flow.ExecutionContext executionContext)
                {
