...
[Generator]
public class FlowGraphGenerator : FlowSourceGenerator, ISourceGenerator
{
    ...
    public void Execute(GeneratorExecutionContext context)
    {
        ...
        foreach (var classDeclaration in receiver.Candidates)
        {
            ...
            var generateAttribute = classSymbol.GetAttributes().FirstOrDefault(x => x.AttributeClass?.ToDisplayString() == "Ceres.Flow.Annotations.GenerateFlowAttribute");
